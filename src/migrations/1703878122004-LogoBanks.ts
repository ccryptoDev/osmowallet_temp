...
export class LogoBanks1703878122004 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "banks" ADD "image" varchar NOT NULL DEFAULT 'https://firebasestorage.googleapis.com/v0/b/osmowallet.appspot.com/o/banks%2Flogo-default.png?alt=media&token=c1d3be47-e6b3-42b5-b2be-130c438b9e13'`);
