...
export class Countrycode1706641702028 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `CREATE TABLE "country_coins" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "country_code" varchar NOT NULL DEFAULT 'GT', "coin_id" uuid, CONSTRAINT "PK_85560a720b7fd595576339615e5" PRIMARY KEY ("id"))`,
        );
