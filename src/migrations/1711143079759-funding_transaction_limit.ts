...
export class FundingTransactionLimit1711143079759 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE "funding_transaction_limits" ADD CONSTRAINT "FK_ff04e7b4c1066344e10e4e72987" FOREIGN KEY ("tier_id") REFERENCES "tiers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
