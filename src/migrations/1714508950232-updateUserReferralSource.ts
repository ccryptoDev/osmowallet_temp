...
export class UpdateUserReferralSource1714508950232 implements MigrationInterface {
    name = 'UpdateUserReferralSource1714508950232'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_referral_source_referral_sources_referral_source" DROP CONSTRAINT "FK_cfeeda4a4100ab8d306691522e6"`);
        await queryRunner.query(`ALTER TABLE "user_referral_source" ALTER COLUMN "id" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "user_referral_source" ALTER COLUMN "id" SET DEFAULT gen_random_uuid()`);
        ...
        await queryRunner.query(`ALTER TABLE "user_referral_source_referral_sources_referral_source" ADD CONSTRAINT "FK_cfeeda4a4100ab8d306691522e6" FOREIGN KEY ("userReferralSourceId") REFERENCES "user_referral_source"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_referral_source" ALTER COLUMN "id" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "user_referral_source" ALTER COLUMN "id" SET DEFAULT unique_rowid()`);
        await queryRunner.query(`ALTER TABLE "user_referral_source_referral_sources_referral_source" ADD CONSTRAINT "FK_cfeeda4a4100ab8d306691522e6" FOREIGN KEY ("userReferralSourceId") REFERENCES "user_referral_source"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "blockchain_network_addresses" ALTER COLUMN "id" DROP DEFAULT`);
