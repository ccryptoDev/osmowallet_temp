...
export class ReferralSource1715012861141 implements MigrationInterface {
    name = 'ReferralSource1715012861141'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_features" ALTER COLUMN "id" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "user_features" ALTER COLUMN "id" SET DEFAULT gen_random_uuid()`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_features" ALTER COLUMN "id" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "user_features" ALTER COLUMN "id" SET DEFAULT unique_rowid()`);
        await queryRunner.query(`ALTER TABLE "cashpak_users" ALTER COLUMN "id" DROP DEFAULT`);
