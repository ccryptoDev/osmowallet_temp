...
export class UpdateUserReferralSource1715028796712 implements MigrationInterface {
    name = 'UpdateUserReferralSource1715028796712'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" UUID DEFAULT gen_random_uuid() NOT NULL, "email" varchar, "password" varchar, "pin" varchar, "is_2fa_enabled" bool DEFAULT false, "username" varchar, "first_name" varchar, "last_name" varchar, "mobile" varchar, "nationality" varchar, "residence" varchar NOT NULL, "username_changes" int8 NOT NULL DEFAULT (0), "last_session" timestamp, "is_active" bool NOT NULL DEFAULT true, "profile_picture" varchar(1000), "profile_picture_path" varchar, "profile_picture_expiry" timestamp, "hash" varchar, "created_at" timestamp NOT NULL DEFAULT now(), "updated_at" timestamp NOT NULL DEFAULT now(), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_fe0bb3f6520ee0469504521e710" UNIQUE ("username"), CONSTRAINT "UQ_d376a9f93bba651f32a2c03a7d3" UNIQUE ("mobile"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "accounts" ("id" UUID DEFAULT gen_random_uuid() NOT NULL, "account_type" varchar NOT NULL DEFAULT 'INDIVIDUAL', "alias" varchar, "user_id" uuid, CONSTRAINT "REL_3000dad1da61b29953f0747632" UNIQUE ("user_id"), CONSTRAINT "PK_5a7a02c20412299d198e097a8fe" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_3000dad1da61b29953f0747632" ON "accounts" ("user_id") `);
        await queryRunner.query(`CREATE TABLE "wallets" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "balance" decimal(15,5) NOT NULL DEFAULT (0), "available_balance" decimal(15,5) NOT NULL DEFAULT (0), "is_active" bool NOT NULL DEFAULT true, "created_at" timestamp NOT NULL DEFAULT now(), "updated_at" timestamp NOT NULL DEFAULT now(), "account_id" uuid, "coin_id" uuid, CONSTRAINT "PK_8402e5df5a30a229380e83e4f7e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "wallet_history" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "balance" decimal(15,5) NOT NULL DEFAULT (0), "available_balance" decimal(15,5) NOT NULL DEFAULT (0), "created_at" timestamp NOT NULL DEFAULT now(), "updated_at" timestamp NOT NULL DEFAULT now(), "date" timestamp NOT NULL, "wallet_id" uuid, CONSTRAINT "PK_d753e93ce16ad3202f03980aef6" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "blockchain_network_addresses" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "address" varchar NOT NULL, "stable" varchar, "user_id" uuid, "networkId" uuid, CONSTRAINT "PK_d1e03b4e3ef880de80b706c6404" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "osmo_business_bpts" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "name" varchar NOT NULL, "bpt_name" varchar NOT NULL, "bpt_url" varchar NOT NULL, "logo" varchar(1000), "created_at" timestamp NOT NULL DEFAULT now(), "updated_at" timestamp NOT NULL DEFAULT now(), CONSTRAINT "PK_738dea986a628a133cbf12a93e6" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "transactions" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "amount" decimal(15,5) NOT NULL DEFAULT (0), "subtype" varchar NOT NULL, "balance" decimal(15,5) NOT NULL DEFAULT (0), "created_at" timestamp NOT NULL DEFAULT now(), "updated_at" timestamp NOT NULL DEFAULT now(), "wallet_id" uuid, "transaction_group_id" uuid, CONSTRAINT "PK_a219afd8dd77ed80f5a862f1db9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "transaction_categories" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "name" varchar NOT NULL, "icon" int8 NOT NULL DEFAULT (61449), "color" varchar NOT NULL DEFAULT '#FF779ECB', "from_user_id" uuid, CONSTRAINT "PK_bbd38b9174546b0ed4fe04689c7" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_56af85400b4f8183aa121d0650" ON "transaction_categories" ("from_user_id") `);
        await queryRunner.query(`CREATE TABLE "transaction_fees" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "amount" decimal(15,3) NOT NULL DEFAULT (0), "source" varchar NOT NULL DEFAULT 'OSMO', "transaction_group_id" uuid, "coin_id" uuid, CONSTRAINT "PK_c4e068e018a1d34dab19b11b3a5" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "tiers" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "name" varchar NOT NULL, CONSTRAINT "PK_908405492b9b2c2ae1cea1e1cc0" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "referral_source" ("id" UUID DEFAULT gen_random_uuid() NOT NULL, "source_name" varchar NOT NULL, CONSTRAINT "PK_ef75f632fea22db528069d98d73" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "preferences" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "fiat_coin" varchar NOT NULL DEFAULT 'GTQ', "crypto_coin" varchar NOT NULL DEFAULT 'SATS', "dynamic_onchain_address" bool NOT NULL DEFAULT false, "promotional_notification" bool NOT NULL DEFAULT true, "security_notification" bool NOT NULL DEFAULT true, "user_id" uuid, "ask_pin_id" uuid, CONSTRAINT "REL_34a542d34f1c75c43e78df2e67" UNIQUE ("user_id"), CONSTRAINT "PK_17f8855e4145192bbabd91a51be" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "otp_codes" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "input" varchar, "otp" int8 NOT NULL, "type" varchar NOT NULL, "expiry" timestamp NOT NULL, "user_id" uuid, CONSTRAINT "PK_9d0487965ac1837d57fec4d6a26" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_318b850fc020b1e0f8670f66e1" ON "otp_codes" ("user_id") `);
        await queryRunner.query(`CREATE TABLE "kyc_verifications" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "document_number" varchar, "status" varchar NOT NULL DEFAULT 'CREATED', "duplicated" bool NOT NULL DEFAULT false, "verification_id" varchar NOT NULL, "attemps" int8 NOT NULL DEFAULT (0), "created_at" timestamp NOT NULL DEFAULT now(), "updated_at" timestamp NOT NULL DEFAULT now(), "user_id" uuid, CONSTRAINT "REL_1e23c7821d740b4881f773c39a" UNIQUE ("user_id"), CONSTRAINT "PK_57b7c6b141dd225ce5dc95d7fb0" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_1e23c7821d740b4881f773c39a" ON "kyc_verifications" ("user_id") `);
        await queryRunner.query(`CREATE TABLE "kyc_verification_steps" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "step" varchar NOT NULL, "verified" bool NOT NULL DEFAULT false, "error" varchar DEFAULT 'no ejecutado', "created_at" timestamp NOT NULL DEFAULT now(), "updated_at" timestamp NOT NULL DEFAULT now(), "kyc_verification_id" uuid, CONSTRAINT "PK_6038442795379a0f5a5031bdbd8" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "banks" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "name" varchar NOT NULL, "code" int8 NOT NULL DEFAULT (0), "country_id" uuid, CONSTRAINT "PK_3975b5f684ec241e3901db62d77" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_47446872bbbcdfe74738c31fff" ON "banks" ("country_id") `);
        await queryRunner.query(`CREATE TABLE "osmo_bank_accounts" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "account_type" varchar DEFAULT 'CORRIENTE', "account_number" varchar NOT NULL, "account_name" varchar NOT NULL, "created_at" timestamp NOT NULL DEFAULT now(), "updated_at" timestamp NOT NULL DEFAULT now(), "coin_id" uuid, "bank_id" uuid, CONSTRAINT "PK_5309246aa45f9db4ea8fb93c784" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "bank_accounts" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "account_type" varchar DEFAULT 'AHORROS', "account_number" varchar NOT NULL, "account_holder" varchar NOT NULL, "created_at" timestamp NOT NULL DEFAULT now(), "updated_at" timestamp NOT NULL DEFAULT now(), "user_id" uuid, "coin_id" uuid, "bank_id" uuid, CONSTRAINT "PK_c872de764f2038224a013ff25ed" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "country_coins" ADD CONSTRAINT "FK_c676fcca1a8ffef876f92d150cc" FOREIGN KEY ("coin_id") REFERENCES "coins"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
