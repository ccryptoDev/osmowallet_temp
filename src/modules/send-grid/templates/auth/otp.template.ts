 ...
 */
    export class OTPSigninTemplate extends SendgridTemplate{
        ...
        <html>
                ...
                ¡Hola, <b>${this.to[0].name ?? ''}</b>!
                <br>
                <br>
                <p><strong>
                IMPORTANTE: Protege Tu Cuenta
                Este es tu código de verificación único para acceder a tu cuenta de OSMO. Recuerda: este código es personal y no debe ser compartido con nadie, bajo ninguna circunstancia.
                En OSMO, valoramos tu seguridad y privacidad; por ello, queremos recordarte que nuestro equipo de servicio al cliente nunca te solicitará que compartas este código.
                Si recibes alguna solicitud sospechosa pidiéndote este código, por favor, ignórala y repórtala inmediatamente a nuestro equipo de soporte a través del chat dentro de la app o nuestros canales oficiales.
                ¡Gracias por confiar en OSMO!</strong></p>
                </p>
                <p style='color: black;font-size: 20px;font-family: 'Helvetica';'>
                Este es tu código OTP:
                </p>
                <p style='color: black;font-size: 20px;font-family: 'Helvetica';'>
                <strong>${this.otp}</strong><br>
                </p>
                <p style='color: black;font-size: 20px;font-family: 'Helvetica';'>
