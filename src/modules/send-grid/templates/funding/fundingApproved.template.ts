 ...
 */
export class FundingApprovedTemplate extends SendgridTemplate{
    ...
    template: string = `
        ...
        <head>
            ...
            <style>
                ...
                .table tr td:first-child.status-success,
                .status-success {
                color: #09B241;
                }
        ...
        <body style="background-color: #fff !important;">
            ...
            Se aprobó un depósito a tu usuario Osmo.
            </p>
    ...
    constructor(
        ...
        this.subject = `Depósito por ${this.fundingDataEmail.amount} ${this.fundingDataEmail.currency} aprobado a tu cuenta Osmo`
