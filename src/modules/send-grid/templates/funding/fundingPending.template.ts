 ...
 */
export class FundingPendingTemplate extends SendgridTemplate{
    ...
    template: string = `
        ...
        <body style="background-color: #fff !important;">
            ...
            Se recibió un depósito pendiente a tu usuario Osmo y está siendo verificado. <br>
            Gracias por hacer tu recarga.
            Recuerda que dado a que no somos un banco, dependemos de horarios, cierres y cortes de nuestros aliados bancarios. 
            Y aunque en promedio los retiros y recargas toman 8 horas hábiles en verse reflejadas, pueden llegar a tomar hasta 2 días hábiles.
            </p>
    ...
    constructor(
        ...
        this.subject = `Depósito por ${this.fundingDataEmail.amount} ${this.fundingDataEmail.currency} a tu cuenta Osmo`
