 ...
 */
export class WithdrawalRejectedTemplate extends SendgridTemplate{
    ...
    template: string = `
        ...
        <body style="background-color: #fff !important;">
            ...
            Tu retiro por ${ this.withdrawalDataEmail.amount } ${ this.withdrawalDataEmail.currency } de tu cuenta Osmo ha sido rechazado
            </p>
    ...
    constructor(
        ...
        this.subject = `Retiro por ${this.withdrawalDataEmail.amount} ${this.withdrawalDataEmail.currency} ha sido rechazado`
