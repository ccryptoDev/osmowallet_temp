...
export class WithdrawalPendingTemplate extends SendgridTemplate{
    ...
    template: string = `
        ...
        <body style="background-color: #fff !important;">
            ...
            Se recibió una solicitud de retiro pendiente a tu usuario Osmo y está siendo verificado. <br>
            Este proceso puede tomar entre 1 y 2 días hábiles.
            </p>
    ...
    constructor(
        ...
        this.subject = `Retiro por ${this.withdrawalDataEmail.amount} ${this.withdrawalDataEmail.currency} desde tu cuenta Osmo`
