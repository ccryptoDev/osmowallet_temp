...
export class WithdrawalPendingOsmoTemplate extends SendgridTemplate{
    ...
    template: string = `
        ...
        <body style="background-color: #fff !important;">
            ...
            ¡Hola Equipo Osmo! <br>
            Se recibió una solicitud de retiro pendiente de un usuario Osmo <br>
            </p>
    ...
    constructor(
        ...
        this.subject = `Retiro por ${this.withdrawalDataEmail.amount} ${this.withdrawalDataEmail.currency} ${(new Date()).toISOString()}`
