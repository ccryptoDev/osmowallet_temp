 ...
 */
export class WithdrawalPendingOsmoTemplate extends SendgridTemplate {
        ...
        <head>
            ...
            <style>
                ...
                *{box-sizing:border-box}body{margin:0;padding:0}a[x-apple-data-detectors]{color:inherit!important;text-decoration:inherit!important}#MessageViewBody a{color:inherit;text-decoration:none}p{line-height:inherit}.desktop_hide,.desktop_hide table{mso-hide:all;display:none;max-height:0;overflow:hidden}.image_block img+div{display:none} @media (max-width:670px){.social_block.desktop_hide .social-table{display:inline-block!important}.image_block div.fullWidth{max-width:100%!important}.mobile_hide{display:none}.row-content{width:100%!important}.stack .column{width:100%;display:block}.mobile_hide{min-height:0;max-height:0;max-width:0;overflow:hidden;font-size:0}.desktop_hide,.desktop_hide table{display:table!important;max-height:none!important}.row-5 .column-1 .block-1.image_block td.pad{padding:0 0 0 5px!important}.row-5 .column-1 .block-2.text_block td.pad{padding:0 0 0 35px!important}.row-5 .column-2 .block-1.social_block td.pad{padding:15px 5px 0 30px!important}}
                ...
                class="alignment" align="center" style="line-height:10px"><div style="max-width:325px"><img src="https://d15k2d11r6t6rl.cloudfront.net/public/users/Integrators/f7683d20-2948-460f-8f91-a13fe519b593/8S7TDHZ1MY25VT9O0AEWVQUF/logo-06.png" style="display:block;height:auto;border:0;width:100%" width="325"></div></div></td></tr></table></td></tr></tbody></table></td></tr></tbody></table><table class="row row-2" align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" 
                ...
                style="mso-table-lspace:0;mso-table-rspace:0;font-weight:400;text-align:left;padding-bottom:5px;padding-top:5px;vertical-align:top;border-top:0;border-right:0;border-bottom:0;border-left:0"><table class="image_block block-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace:0;mso-table-rspace:0"><tr><td class="pad" style="padding-left:10px;width:100%;padding-right:0"><div class="alignment" align="center" style="line-height:10px"><div 
                class="fullWidth" style="max-width:552.5px"><img src="https://d15k2d11r6t6rl.cloudfront.net/public/users/Integrators/f7683d20-2948-460f-8f91-a13fe519b593/8S7TDHZ1MY25VT9O0AEWVQUF/%C2%A1bitcoin%20GRATIS%20ESTE%20FINDE%21%20%285%29.png" style="display:block;height:auto;border:0;width:100%" width="552.5"></div></div></td></tr></table><table class="divider_block block-2" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace:0;mso-table-rspace:0"><tr><td
                ...
                style="font-size:14px;font-family:Figtree,sans-serif;mso-line-height-alt:16.8px;color:#555;line-height:1.2"><p style="margin:0;font-size:14px;mso-line-height-alt:16.8px"><span style="color:#000000;font-size:14px;"><span style="color:#4e4d4d;">Usuario:</span>  ${formatName(
                    this.clientName,
                )}</span></p><p style="margin:0;mso-line-height-alt:16.8px"> </p><p style="margin:0;mso-line-height-alt:16.8px">Monto: ${
                    this.withdrawalDataEmail.currency
                }${formatAmount(this.withdrawalDataEmail.amount)}</p><p style="margin:0;mso-line-height-alt:16.8px"> </p><p 
                style="margin:0;mso-line-height-alt:16.8px">Email: ${
                    this.clientEmail
                }</p><p style="margin:0;mso-line-height-alt:16.8px"> </p><p style="margin:0;mso-line-height-alt:16.8px">Nota: -</p><p style="margin:0;font-size:14px;mso-line-height-alt:16.8px"><br><span style="color:#4e4d4d;font-size:14px;">ID de transacción: ${
                    this.withdrawalDataEmail.transactionId
                }</span></p><p style="margin:0;font-size:14px;mso-line-height-alt:16.8px"> </p><p style="margin:0;font-size:14px;mso-line-height-alt:16.8px">
                <span style="color:#4e4d4d;font-size:14px;">Fecha: 03/20/2024</span></p><p style="margin:0;font-size:14px;mso-line-height-alt:16.8px"> </p><p style="margin:0;font-size:14px;mso-line-height-alt:16.8px"><span style="color:#4e4d4d;font-size:14px;">Estado: ${
                    this.withdrawalDataEmail.status
                }</span></p></div></div></td></tr></table></td></tr></tbody></table></td></tr></tbody></table><table class="row row-4" align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" 
                style="mso-table-lspace:0;mso-table-rspace:0;background-color:#fff"><tbody><tr><td><table class="row-content stack" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace:0;mso-table-rspace:0;background-color:#fff;border-radius:0;color:#000;width:650px;margin:0 auto" width="650"><tbody><tr><td class="column column-1" width="100%" 
    ...
    constructor(
        ...
        this.subject = `Retiro por ${this.withdrawalDataEmail.currency}${formatAmount(
            this.withdrawalDataEmail.amount,
